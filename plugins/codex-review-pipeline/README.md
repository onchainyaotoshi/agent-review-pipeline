...
Automated 2-stage code review pipeline for Claude Code, powered by [Codex](https://github.com/openai/codex-plugin-cc).
...
- [Codex plugin](https://github.com/openai/codex-plugin-cc) installed:
